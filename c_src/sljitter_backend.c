...
#define BE_RUN  NULL
#define BE_SIMD_ARITH1 sljit_emit_simd_arith_op1
#define BE_SIMD_ARITH2 sljit_emit_simd_arith_op2
...
#define BE_RUN  NULL
#define BE_SIMD_ARITH1 NULL
#define BE_SIMD_ARITH2 NULL
...
sljitter_backend_t BE_NAME =
{
    ...
    .emit_simd_arith_op1 = BE_SIMD_ARITH1,    
    .emit_simd_arith_op2 = BE_SIMD_ARITH2,    
